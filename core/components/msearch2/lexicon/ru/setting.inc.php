...
$_lang['setting_mse2_index_all'] = 'Добавлять все слова в индекс';
$_lang['setting_mse2_index_all_desc'] = 'Эта опция добавляет все необычные слова для индексации, даже если они не были найдены в словарях.';
...
$_lang['setting_mse2_search_like_match_bonus'] = 'Балл за неточное совпадение';
$_lang['setting_mse2_search_like_match_bonus_desc'] = 'Укажите, сколько баллов добавлять за неточное совпадение поисковой фразы и содержимого страницы. По умолчанию - "3".';
