...
$sources = array(
	...
	,'phpmorphy' => $root.'core/components/'.PKG_NAME_LOWER.'/phpmorphy/'
);
unset($root);
...
// Removing phpMorphy dictionaries
if (BUILD_REMOVE_DICTS) {
	rrmdir($sources['phpmorphy'] . 'dicts');
}
